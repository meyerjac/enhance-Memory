...
public class StageFourActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String passed61 = mSharedPreferences.getString(Constants.S1LEVEL61COMPLETE, null);
        String passed62 = mSharedPreferences.getString(Constants.S1LEVEL62COMPLETE, null);
        String passed63 = mSharedPreferences.getString(Constants.S1LEVEL63COMPLETE, null);
        String passed64 = mSharedPreferences.getString(Constants.S1LEVEL64COMPLETE, null);
        String passed65 = mSharedPreferences.getString(Constants.S1LEVEL65COMPLETE, null);
        String passed66 = mSharedPreferences.getString(Constants.S1LEVEL66COMPLETE, null);
        String passed67 = mSharedPreferences.getString(Constants.S1LEVEL67COMPLETE, null);
        String passed68 = mSharedPreferences.getString(Constants.S1LEVEL68COMPLETE, null);
        String passed69 = mSharedPreferences.getString(Constants.S1LEVEL69COMPLETE, null);
        String passed70 = mSharedPreferences.getString(Constants.S1LEVEL70COMPLETE, null);
        String passed71 = mSharedPreferences.getString(Constants.S1LEVEL71COMPLETE, null);
        String passed72 = mSharedPreferences.getString(Constants.S1LEVEL72COMPLETE, null);
        String passed73 = mSharedPreferences.getString(Constants.S1LEVEL73COMPLETE, null);
        String passed74 = mSharedPreferences.getString(Constants.S1LEVEL74COMPLETE, null);
        String passed75 = mSharedPreferences.getString(Constants.S1LEVEL75COMPLETE, null);
        String passed76 = mSharedPreferences.getString(Constants.S1LEVEL76COMPLETE, null);
        String passed57 = mSharedPreferences.getString(Constants.S1LEVEL77COMPLETE, null);
        String passed78 = mSharedPreferences.getString(Constants.S1LEVEL78COMPLETE, null);
        String passed79 = mSharedPreferences.getString(Constants.S1LEVEL79COMPLETE, null);
        String passed80 = mSharedPreferences.getString(Constants.S1LEVEL80COMPLETE, null);
